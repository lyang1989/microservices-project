package com.princeli.micro.services.spring.cloud.servlet.gateway.servlet;
...
public class RibbonGatewayServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String targetURL = buildTargetURI(server,serviceURI,request);
    ...
    private String buildTargetURI(Server server, String serviceURI,HttpServletRequest request) {
